...
class InvoiceController extends Controller
{
    ...
    public function InvoiceAdd(){
        ...
        $date = date('Y-m-d');
        return view('backend.invoice.invoice_add',compact('invoice_no','product','date','customer'));
    ...
    public function invoice_approve_store(Request $request, $id){
        ...
        return redirect()->route('invoice.all')->with('success','Invoice Approve Successfully');  
